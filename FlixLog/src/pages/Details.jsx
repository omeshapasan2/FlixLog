    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#0d0d0d] text-black dark:text-white">
            ...
            <div className="relative min-h-screen">
                ...
                <div className="relative z-10 container mx-auto px-4 min-h-screen flex items-end pb-20">
            ...
            {trailer && (
                <section className="relative z-10 py-12">
                    <div className="container mx-auto px-4">
                        <h2 className="text-3xl font-bold text-white mb-6 text-center">Watch Trailer</h2>
                            ...
                            <div key={season.id} className="mb-6">
                                ...
                                >
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span 
                                            className={`text-2xl text-white font-bold transition-transform duration-300 ease-in-out ${
                                    ...
                                    {season.overview && (
                                        <p className="text-purple-100 dark:text-purple-200 mt-3 leading-relaxed">{season.overview}</p>
                                    )}
                                </button>
                                ...
                                >
                                    {expandedSeasons.has(season.season_number) && episodes[season.season_number] && (
                                        <div className="mt-6 space-y-4 animate-fadeIn pl-4 border-l-4 border-purple-300 dark:border-purple-500">
                                            {episodes[season.season_number].map((episode, index) => (
                                                <div 
                                                    key={episode.id} 
                                                    className="flex gap-5 p-5 bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-750 transition-all duration-300 ease-in-out transform hover:scale-[1.002] hover:shadow-lg ml-2"
                                                    style={{
                                                ...
                                                >
                                                    {episode.still_path && (
                                                        <div className="flex-shrink-0">
                                                            <img
                                                                ...
                                                                alt={episode.name}
                                                                className="w-44 h-26 object-cover rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 transition-transform duration-300 hover:scale-105"
                                                            />
                                                        </div>
                                                    )}
                                                    <div className="flex-1 min-w-0">
                                                        <div className="flex items-center gap-3 mb-3">
                                                            ...
                                                            <h4 className="font-semibold text-gray-800 dark:text-gray-100 text-lg truncate">{episode.name}</h4>
